...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtDcuentos = new javax.swing.JTextField();
        ...
        jPanel1.add(txtHT, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 80, 90, -1));

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel3.setText("Descuento");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 110, -1, -1));
        jPanel1.add(txtDcuentos, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 110, 90, -1));

        jLabel4.setText("Total A Pagar");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 140, -1, -1));
        jPanel1.add(txtTP, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 140, 90, -1));
        ...
        jPanel1.add(cmdBorrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 190, -1, -1));
    ...
    private void cmdCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCalcularActionPerformed
        ...
        String Hrs, Dtos, Total;
        double Hras, Dcuentos, Mt, Total1;
        
        txtDcuentos.setText("");
        txtTP.setText("");
        if (txtHT.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Digite por favor el número de horas", "Error", JOptionPane.ERROR_MESSAGE);
            txtHT.requestFocusInWindow();
        } else {
            Hras = Double.parseDouble(txtHT.getText());
            Total1 = Hras * 20000;
            Dcuentos = Total1 * 0.05;
            Mt = Total1 - Dcuentos;
            Total = String.valueOf(Mt);
            Dtos = String.valueOf(Dcuentos);
            txtDcuentos.setText(Dtos);
            txtTP.setText(Total);
        }
    ...
    private javax.swing.JTextField txtDcuentos;
